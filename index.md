<!DOCTYPE html>
  <head>
    <title>Polygon Photography</title>
                	...
                	<div class="col-md-3 col-sm-4">
                        	 <div class="hexagon hexagonteam gallery-item">
                               <div class="hexagon-in1">
                                ...
                                <div class="clear"></div>
                               	<div class="overlay templatemo_overlaytxt">Wedding Photography</div>
                                </div>
                            </div>
                          </div>
  			       </div>
        	...
        	<div class="templatemo_hexservices col-sm-6">
            	<div class="blok text-center">
                  <div class="hexagon-a">
                    ...
                    <p>A good landscape photograph is about more than just an interesting subject and a proper exposure. A good landscape photo is able to capture and keep the viewer's attention by telling a story and evoking feelings.</p>
                    </div>
              </div>
              <div class="templatemo_hexservices col-sm-6">
            	<div class="blok text-center">
                  <div class="hexagon-a">
                    ...
                    <p>The most important rule when making a portrait is that there are no rules. You can pose subjects or capture them naturally. You can choose to alter lighting in a studio or use natural lighting. There are no rules, but each decision we make changes how the viewer perceives the photograph..</p>
                    </div>
              </div>
              <div class="templatemo_hexservices col-sm-6">
            	<div class="blok text-center">
                  <div class="hexagon-a">
                    ...
                    <p>Wildlife photography is all about capturing animals in their natural habitats. The animals are often photographed in action, such as eating, fighting, or in flight. Alternatively, more static portraits may be used to show detail of the animal or to depict it in its environment.
                      .</p>
                    </div>
              </div>
              <div class="templatemo_hexservices col-sm-6">
            	<div class="blok text-center">
                  <div class="hexagon-a">
                     ...
                     <div class="templatemo_servicetext">
                    <h3>Sports / Action Photography</h3>
                    <p>What is sports and action photography?
                      Image result for sports / action photography
                      refers to the genre of photography that covers all types of sports. In the majority of cases, professional sports photography is a branch of photojournalism, while amateur sports photography, such as photos of children playing association football, is a branch of vernacular photography..</p>
                    </div>
              </div>
              <div class="templatemo_hexservices col-sm-6">
            	<div class="blok text-center">
                  <div class="hexagon-a">
                    ...
                    <p>Architectural photography is a genre of photography that focuses on capturing photographs of buildings or structures. Hence, it also involves photographing the interiors and exteriors of buildings, bridges, structures, and cityscapes..</p>
                    </div>
              </div>
    ...
    <div class="container">
     	<div class="row">
            ...
            <div class="col-md-3 col-sm-12 leftalign">
                ...
                <div class="clear"></div>
                <p>We are from Sorsogon State University/Bachelor of Science in Information Technology (BSIT)
                  second year college
                </p>
                <div class="templatemo_address">
                	<ul>
                	<li class="left fa fa-map-marker"></li>
                    <li class="right">Zone VIII Pob. (Brgy 8- Loyo)Bulan, Sorsogon
                    </li>
                    <li class="clear"></li>
                    <li class="left fa fa-phone"></li>
                    <li class="right">09501971609</li>
                    <li class="clear"></li>
                    <li class="left fa fa-envelope"></li>
                    <li class="right">juliusfuring02@gmail.com/li>
                    </ul>
                </div>
            </div>
